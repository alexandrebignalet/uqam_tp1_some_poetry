...
public class PoemTest {
    ...
    public void testPoemAddStanza() {
        ...
        verses.add(new Verse("J'voulais juste grailler /ai/"));
        verses.add(new Verse("QLF ne cherche pas d'alliés /ai/"));
        verses.add(new Verse("Eh zut la vie est bonne, bonne à niquer /ai/"));
        verses.add(new Verse("Ils vendent leur ***, leur mère /ère/"));
        verses.add(new Verse("On n'imagine pas cette vie sans remporter la guerre /ère/"));
